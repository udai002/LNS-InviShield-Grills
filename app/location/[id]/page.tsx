    ...
    <div className="relative z-20 flex flex-col justify-end h-full px-6 md:px-16 pb-12">
      ...
      >
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">
          Elisha Safety Nets <br />
          <span className="text-green-400">and Invisible Grills</span>
          <span className="block mt-3 text-lg md:text-2xl font-semibold text-white/90">
            {location.city}
          </span>
        </h1>
        <p className="mt-4 text-white/80 text-lg max-w-2xl leading-relaxed">
          {location.description ||
            `Premium safety net and invisible grill installations in ${location.area}, ${location.city}. Trusted by hundreds of families for safety without compromising your view.`}
        </p>
    ...
    <div className="grid md:grid-cols-2 gap-10 items-center">
      ...
      >
        ...
        <p className="mt-4 text-gray-600 leading-relaxed">
          Elisha Safety Nets and Invisible Grills provide industry-leading safety net and invisible grill solutions across {location.city}.
...
export default function LocationScreen() {
  ...
  return (
    <>
      <Head>
        <title>
          Elisha Safety Nets and Invisible Grills in {locationData.area}, {locationData.city}
        </title>
        <meta
          name="description"
          content={`Buy & install premium safety nets and invisible grills in ${locationData.area}, ${locationData.city}, ${locationData.state} - ${locationData.pincode}. Safe, rust-proof, child-friendly. Free site visit. Call Elisha Safety Nets and Invisible Grills.`}
        />
        <meta
          name="keywords"
        ...
        />
        <meta property="og:title" content={`Elisha Safety Nets and Invisible Grills in ${locationData.city}`} />
        <meta
          property="og:description"
          content={`Premium safety net and invisible grill installations in ${locationData.area}, ${locationData.city}. Trusted, certified, and affordable.`}
        />
      </Head>
