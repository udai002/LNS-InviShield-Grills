...
export const {useLazyGetLocationsQuery , useCreateLocationMutation , useGetLocationByIdQuery , useDeleteLocationMutation , useLazyGetLocationByIdQuery , useUpdateLocationMutation } = locationApi