      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 p-6 sm:p-8 lg:p-12 gap-8'>
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            >
             Elisha’s Trusted safety nets and grills fabricators
            </motion.p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            ...
            Safe and strong safety nets and grills for your home
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <p className='text-gray-500 text-base sm:text-lg lg:text-xl'>
              Elisha safety nets and invisible grills offer a modern, clean look with strong stainless steel cables for safety. Perfect as invisible grills for balcony in Puri, Bhubaneswar,cuttack ,balasore and safety grills for balcony, they blend easily with any home interior.
            </p>
          </motion.div>
